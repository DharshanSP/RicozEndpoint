...
export function DeviceDetailsPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 max-w-7xl mx-auto animate-pulse">
        ...
        <div className="h-28 w-full bg-slate-900/60 rounded-lg border border-slate-800" />
        <div className="h-10 w-full bg-slate-900/40 rounded-lg border border-slate-800" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="h-64 bg-slate-900/40 rounded-lg border border-slate-800" />
          <div className="h-64 bg-slate-900/40 rounded-lg border border-slate-800" />
        </div>
      </div>
    );
  ...
  if (error || !device) {
    return (
      <div className="max-w-xl mx-auto my-12 p-8 rounded-xl bg-slate-900/60 border border-slate-800 text-center space-y-4">
        <div className="inline-flex p-3 rounded-full bg-rose-500/10 text-rose-400 border border-rose-500/20">
          <XCircle className="w-6 h-6" />
        </div>
        <h2 className="text-lg font-bold text-slate-100">Endpoint Not Found</h2>
        <p className="text-xs text-slate-400">{error || 'Requested device was not found in fleet inventory.'}</p>
        <div className="pt-2">
          <Link to="/devices">
            <Button variant="outline" size="sm" className="text-xs border-slate-800 bg-slate-900 text-slate-200">
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="p-6 rounded-xl bg-slate-900/60 border border-slate-800/90 shadow-sm space-y-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          {/* Device identity */}
          <div className="flex items-start gap-3.5">
            <div className="p-3 rounded-xl bg-blue-600/10 border border-blue-500/30 text-blue-400 shrink-0 mt-0.5">
              <Laptop className="w-6 h-6" />
            </div>
            <div className="space-y-1">
              <div className="flex items-center gap-2.5 flex-wrap">
                <h1 className="text-2xl font-bold text-slate-100 tracking-tight">{device.deviceName}</h1>
                {/* Status Badge */}
                {isOnline && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-xs font-medium border border-emerald-500/30 bg-emerald-500/10 text-emerald-400">
                ...
                {isOffline && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-xs font-medium border border-amber-500/30 bg-amber-500/10 text-amber-400">
                    <span className="w-2 h-2 rounded-full bg-amber-500" />
                    Offline
                  </span>
                )}
                {!isOnline && !isOffline && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-xs font-medium border border-blue-500/30 bg-blue-500/10 text-blue-400">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-400 font-mono flex-wrap">
                <span>Hostname: <strong className="text-slate-300 font-normal">{device.hostname}</strong></span>
                <span>•</span>
                <span>Serial: <strong className="text-slate-300 font-normal">{device.serialNumber}</strong></span>
                <span>•</span>
                <span>IP: <strong className="text-slate-300 font-normal">{device.ipAddress || 'Not Assigned'}</strong></span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap self-start lg:self-auto">
            ...
            <Button
              ...
              className="h-8 px-2 text-xs border-slate-800 bg-slate-950 text-slate-300 hover:bg-slate-800"
            >
        ...
        {actionNotice && (
          <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-xs text-blue-300 flex items-center justify-between gap-3 animate-in fade-in">
      ...
      {/* Tabs Navigation Bar */}
      <div className="border-b border-slate-800/90 flex items-center gap-1 overflow-x-auto text-xs font-medium">
        {[
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">System Identity</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Device Name</span>
                  <span className="font-medium text-slate-200">{device.deviceName}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Hostname</span>
                  <span className="font-mono text-slate-200">{device.hostname}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                ...
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  ...
                  <span className="text-slate-200">{device.manufacturer || 'Standard OEM'}</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Model</span>
                  <span className="text-slate-200">{device.model || 'OEM Workstation'}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">OS & Agent Specs</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Operating System</span>
                  <span className="font-medium text-slate-200">{device.os}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">OS Build / Version</span>
                  <span className="font-mono text-slate-200">{device.osVersion}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Architecture</span>
                  <span className="font-mono text-slate-200">{device.architecture}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Agent Daemon</span>
                  <span className="font-mono text-blue-400 font-semibold">{device.agentVersion || 'v0.1.0'}</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Registration Date</span>
                  <span className="text-slate-200">{new Date(device.registeredAt).toLocaleDateString()}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">Network & Heartbeat</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                ...
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  ...
                  <span className="font-semibold text-slate-200">{device.status}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                ...
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  ...
                  <span className="font-mono text-slate-300">60s (Default)</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Organization ID</span>
                  <span className="font-mono text-slate-400 truncate max-w-[120px]">{device.organizationId}</span>
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-sm font-semibold text-slate-200">Hardware Specifications</CardTitle>
                  </div>
                  <button
              ...
              <CardContent className="p-5 pt-0">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                  <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 space-y-1">
                    <span className="text-[11px] text-slate-400 block">Processor (CPU)</span>
                    <span className="font-semibold text-slate-200 block truncate">{device.hardware.cpu}</span>
                    <span className="text-[11px] text-slate-400 font-mono block">{device.hardware.cpuCores} Cores</span>
                  </div>
                  ...
                  <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 space-y-1">
                    ...
                    <span className="text-[11px] text-emerald-400 block">DDR5 High Speed</span>
                  </div>

                  <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 space-y-1">
                    <span className="text-[11px] text-slate-400 block">Primary Storage</span>
                    <span className="font-semibold text-slate-200 block">
                      {Math.round(Number(device.hardware.storageBytes) / (1024 * 1024 * 1024 * 1024))} TB NVMe
                    </span>
                    <span className="text-[11px] text-blue-400 block">Encrypted</span>
                  </div>

                  <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 space-y-1">
                    <span className="text-[11px] text-slate-400 block">BIOS / Firmware</span>
                    <span className="font-semibold text-slate-200 block truncate">{device.hardware.biosVersion}</span>
                    <span className="text-[11px] text-slate-400 block">UEFI Secure Boot</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  <Cpu className="w-4 h-4 text-blue-400" />
                  <CardTitle className="text-sm font-semibold text-slate-200">Processor & Architecture</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="space-y-1 py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400 text-[11px] block">CPU Model</span>
                  <span className="font-medium text-slate-200 block">{device.hardware?.cpu || 'Standard Multi-Core CPU'}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Total Cores / Threads</span>
                  <span className="font-mono text-slate-200">{device.hardware?.cpuCores || 8} Cores / {(device.hardware?.cpuCores || 8) * 2} Threads</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                ...
                <div className="flex justify-between py-1.5">
                  ...
                  <span className="text-emerald-400 font-medium">Enabled (VT-x / ARM Virtualization)</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">System Memory (RAM)</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                ...
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  ...
                  <span className="font-mono text-slate-200">{isMac ? 'Unified LPDDR5' : 'DDR5 SDRAM (Dual Channel)'}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Memory Bus Speed</span>
                  <span className="font-mono text-slate-200">5600 MT/s</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">ECC Error Correction</span>
                  <span className="text-slate-400">Non-ECC Enterprise Workstation</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  <Server className="w-4 h-4 text-purple-400" />
                  <CardTitle className="text-sm font-semibold text-slate-200">Storage & Volumes</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Primary NVMe SSD</span>
                ...
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Partition Table</span>
                  <span className="font-mono text-slate-200">GPT (GUID Partition Table)</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Drive SMART Health</span>
                  <span className="text-emerald-400 font-medium">Healthy (100% Life Remaining)</span>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">Graphics & Display Engine</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">GPU Controller</span>
                  <span className="font-medium text-slate-200">
                    {isMac ? 'Apple Silicon Integrated 18-Core GPU' : isWin ? 'Intel Iris Xe Graphics / Direct3D 12' : 'Integrated AMD Radeon 780M'}
                  </span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">Active Displays</span>
                  <span className="text-slate-200">1 Built-in Display (3024 x 1964 @ 120Hz)</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Hardware Acceleration</span>
                  <span className="text-emerald-400 font-medium">Metal 3 / Vulkan / DirectX 12 Ready</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-slate-800/90 bg-slate-900/40">
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-semibold text-slate-200">Motherboard & Security Hardware</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="p-5 pt-0 space-y-3 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">System Board / Serial</span>
                  <span className="font-mono text-slate-200">{device.serialNumber}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">BIOS / Firmware Build</span>
                  <span className="font-mono text-slate-200">{device.hardware?.biosVersion || 'UEFI 2.8.0'}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-800/60">
                  <span className="text-slate-400">TPM / Security Enclave</span>
                  <span className="text-emerald-400 font-medium">TPM 2.0 Active (Hardware Root of Trust)</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-400">Secure Boot State</span>
                  <span className="text-emerald-400 font-medium">Enforced & Verified</span>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <CardHeader className="p-5 pb-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-sm font-semibold text-slate-200">Installed Software Inventory</CardTitle>
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-1.5 text-xs rounded-md bg-slate-950 border border-slate-800 text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-5 pt-0 space-y-4">
            ...
            <div className="flex items-center gap-3 text-xs flex-wrap">
              <span className="px-2.5 py-1 rounded bg-slate-950 border border-slate-800 text-slate-300">
                Total Packages: <strong className="text-white">{device.software?.length || 0}</strong>
              </span>
              ...
              <span className="px-2.5 py-1 rounded bg-slate-950 border border-slate-800 text-blue-400">
                    ...
                    filteredSoftware.map((sw) => (
                      <tr key={sw.id} className="hover:bg-slate-800/30 transition-colors">
                        <td className="py-2.5 px-4">
                          <div className="font-semibold text-slate-200">{sw.name}</div>
                        </td>
                        <td className="py-2.5 px-4 text-slate-400">{sw.publisher || 'Enterprise Vendor'}</td>
                        <td className="py-2.5 px-4 font-mono text-slate-300">{sw.version}</td>
                        <td className="py-2.5 px-4 font-mono text-slate-400 hidden sm:table-cell">{sw.architecture}</td>
          ...
          <CardHeader className="p-5 pb-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-purple-400" />
                <div>
                  <CardTitle className="text-sm font-semibold text-slate-200">Assigned Configuration Policies</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
              ...
              <div className="flex items-center gap-1.5 bg-slate-950 border border-slate-800 rounded-md px-2.5 py-1 text-xs">
                ...
                >
                  ...
                  <option value="CONFIGURATION" className="bg-slate-900 text-slate-200">Configuration</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {filteredPolicies.map((asgn) => {
                ...
                return (
                  <div
                    key={asgn.id}
                    className="p-4 rounded-lg bg-slate-950/60 border border-slate-800 space-y-3 text-xs"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2">
                          <span className="font-semibold text-slate-200 text-xs">{pol.name}</span>
                          <Badge
                    ...
                    <div className="p-2.5 rounded bg-slate-900/80 border border-slate-800/80 font-mono text-[11px] text-slate-300 space-y-1">
                      <span className="text-[10px] text-slate-500 uppercase tracking-wider block font-sans font-semibold">
                        Policy Parameters:
                      </span>
                      <div className="text-slate-400 break-all">{pol.settings}</div>
                    </div>

                    <div className="flex items-center justify-between text-[11px] text-slate-400 pt-1 border-t border-slate-800/60">
                      <span>Priority: <strong className="text-slate-200 font-normal">Level {asgn.priority}</strong></span>
        ...
        <Card className="border-slate-800/90 bg-slate-900/40">
          <CardHeader className="p-5 pb-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-sm font-semibold text-slate-200">Security & Compliance Audits</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
              ...
              <div className="flex items-center gap-1.5 bg-slate-950 border border-slate-800 rounded-md px-2.5 py-1 text-xs">
                ...
                >
                  ...
                  <option value="COMPLIANT" className="bg-slate-900 text-emerald-400">
                    Compliant ({complianceMetrics.compliant})
                  </option>
                  <option value="WARNING" className="bg-slate-900 text-amber-400">
                    Warning / At Risk ({complianceMetrics.warning})
                  </option>
                  <option value="NON_COMPLIANT" className="bg-slate-900 text-rose-400">
          ...
          <CardContent className="p-5 pt-0 space-y-4">
            ...
            {filteredCompliance.length > 0 ? (
                ...
                {filteredCompliance.map((result) => {
                  ...
                  return (
                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          {isCompliant && <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />}
                          {isWarning && <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0" />}
                          {isNonCompliant && <XCircle className="w-4 h-4 text-rose-400 shrink-0" />}
                          <span className="font-semibold text-slate-200">{rule?.name || 'CIS Security Rule'}</span>
                          <Badge variant="outline" className="text-[10px] font-mono text-slate-400">
                            {rule?.ruleType || 'BASELINE'}
                          </Badge>
                        </div>
                        <p className="text-slate-400 pl-6 text-[11px]">{result.reason}</p>
                      </div>
              ...
              <div className="p-8 text-center text-xs text-slate-400 space-y-3 bg-slate-950/40 rounded-lg border border-slate-800/80">
          ...
          <CardHeader className="p-5 pb-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-sm font-semibold text-slate-200">Remote Command Execution History</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
              ...
              <div className="flex items-center gap-1.5 bg-slate-950 border border-slate-800 rounded-md px-2.5 py-1 text-xs">
                ...
                <select
                  ...
                  className="bg-transparent text-slate-200 text-xs focus:outline-none cursor-pointer"
                >
                  <option value="ALL" className="bg-slate-900 text-slate-200">All Commands</option>
              ...
              <table className="w-full text-left border-collapse text-xs">
                ...
                <tbody className="divide-y divide-slate-800/80">
                  {filteredCommands.map((cmd) => (
                    <tr key={cmd.id} className="hover:bg-slate-800/30 transition-colors">
                      <td className="py-3 px-4">
                        <span className="font-mono font-semibold text-blue-400 text-[11px] bg-slate-950 px-2 py-0.5 rounded border border-slate-800">
                          {cmd.type}
                        </span>
                      </td>
                      <td className="py-3 px-4 text-slate-300">{cmd.requestedBy || 'System Admin'}</td>
                      <td className="py-3 px-4 text-slate-400 font-mono text-[11px] max-w-md truncate">
                        {cmd.result || 'Command execution finished.'}
                      </td>
                      <td className="py-3 px-4 text-slate-500 font-mono text-[11px] hidden md:table-cell">
          ...
          <CardHeader className="p-5 pb-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <CardTitle className="text-sm font-semibold text-slate-200">Endpoint Activity Timeline</CardTitle>
                  <CardDescription className="text-xs text-slate-400">
              ...
              <div className="flex items-center gap-1.5 bg-slate-950 border border-slate-800 rounded-md px-2.5 py-1 text-xs">
                ...
                >
                  ...
                  <option value="TELEMETRY" className="bg-slate-900 text-slate-200">Telemetry / Heartbeat</option>
                  <option value="SECURITY" className="bg-slate-900 text-slate-200">Security & Policy</option>
                  <option value="COMMAND" className="bg-slate-900 text-slate-200">Admin Commands</option>
                </select>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-5 pt-0">
            ...
            <div className="relative pl-6 space-y-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-800">
              ...
              <div className="relative space-y-1">
                <div className="absolute -left-[25px] top-1 w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-slate-950" />
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-200">Telemetry Heartbeat Check-in</span>
                  <span className="text-[11px] text-slate-500 font-mono">2 minutes ago</span>
                </div>
              ...
              {/* Event 2 */}
              <div className="relative space-y-1">
                <div className="absolute -left-[25px] top-1 w-3 h-3 rounded-full bg-blue-500 ring-4 ring-slate-950" />
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-200">Policy Baseline Synchronization</span>
                  <span className="text-[11px] text-slate-500 font-mono">18 minutes ago</span>
                </div>
                <p className="text-[11px] text-slate-400">
              ...
              {/* Event 3 */}
              <div className="relative space-y-1">
                <div className="absolute -left-[25px] top-1 w-3 h-3 rounded-full bg-purple-500 ring-4 ring-slate-950" />
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-200">Software Inventory Refresh</span>
                  <span className="text-[11px] text-slate-500 font-mono">2 hours ago</span>
                </div>
                <p className="text-[11px] text-slate-400">
              ...
              <div className="relative space-y-1">
                <div className="absolute -left-[25px] top-1 w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-slate-950" />
                <div className="flex items-center justify-between text-xs">
                  <span className="font-semibold text-slate-200">Endpoint Registered & Enrolled</span>
                  <span className="text-[11px] text-slate-500 font-mono">{new Date(device.registeredAt).toLocaleDateString()}</span>
                </div>
                <p className="text-[11px] text-slate-400">
